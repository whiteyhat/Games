mit.main = function () {
  ...
  */
  ...
  tweet.href = 'http://twitter.com/share?url=https://satoshis.games/&text=I am playing Flappy Crypto: Get %23Bitcoin while gaming! Using %23LightningNetwork ! &count=horiztonal&&related=solitarydesigns';

  var facebook = document.getElementById("fb");
  facebook.href = 'http://facebook.com/sharer.php?s=100&p[url]=https://satoshis.games/&p[title]=I am playing Flappy Crypto: Get %23Bitcoin while gaming! Using %23LightningNetwork !';
  ...
  */
  mit.gameOver = function () {
    ...
    // Share
    var tweet = document.getElementById("tweet");
    tweet.href = 'http://twitter.com/share?url=http://satoshis.games/&text=I just scored ' + Math.floor(mit.score) + ' points in Flappy Crypto using %23LightningNetwork ! Get %23Bitcoin for gaming!';

    var facebook = document.getElementById("fb");
    facebook.href = 'http://facebook.com/sharer.php?s=100&p[url]=http://khele.in/pappu-pakia/&p[title]=I just scored ' + Math.floor(mit.score) + '  points in Flappy Crypto using %23LightningNetwork ! Get %23Bitcoin for gaming!';

    localStorage.highScore = mit.highScore;
