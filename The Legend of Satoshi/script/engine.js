(function() {
  var Engine = (window.Engine = {
    SITE_URL: encodeURIComponent("http://satoshis.games/satoshi"),
    VERSION: 1.3,
      ...
      Events.startEvent(
        {
          ...
          scenes: {
            start: {
              text: [_("bring your friends to deep into the Legend of Satoshi.")],
              buttons: {
                twitter: {
                  text: _("twitter"),
                  nextScene: "end",
                  onChoose: function() {
                    window.open(
                      "https://twitter.com/intent/tweet?text=the%20Legend%20of%20Satoshi&url=" +
                        Engine.SITE_URL,
                      "sharer",
